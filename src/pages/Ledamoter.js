    ...
    <section className="ledamöter-wrapper">
      <article className="akademins-stolar">
        ...
        <p className="akademins-stolar-innehåll">
          I akademin sitter välrenommerade personer inom olika kreativa
          verksamhetsområden. Journalister, copywriters och redaktörer.
          Arkitekter, konstnärer och fotografer. Producenter, illustratörer och
          filmregissörer. Hantverken är spridda men det som förenar är att alla
          bidrar till ett skapande inom bild eller ord.
        </p>
      </article>
